...
const App = () => {
  const users = [
    ...
    { 
      img : 'https://images.unsplash.com/photo-1616587894417-b93dfd1f700a?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 
      intro : '',
      tag : 'Underserved'
    },
    { 
